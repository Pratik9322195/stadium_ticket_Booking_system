 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container h-100 d-flex align-items-center justify-content-center w-100">
        <div class="text-center text-white w-100">
            <h1 class="display-4 fw-bolder">Available Stadium</h1>
                                ...
                                <dt class="h3">
                                    <center>
                                        <div class="position-relative overflow-hidden thumb-holder">
                                                <img src="https://media.istockphoto.com/id/482427926/video/lights-flashing-in-large-football-stadium.jpg?s=640x640&k=20&c=xLr9dPS7Aj4DRse5CHcGe7Z_ihNlnXXMk8OFXQ6P8Vs=" alt="" class="img-fluid facility-thumbnail">
                                    </div>
                                    </center>
                                </dt>
                                <dd class=" lh-1">
